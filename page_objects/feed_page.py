...
class FeedPage(BasePage):
    ...
    def get_daily_quantity_of_orders(self):
        self.find_element_with_wait(FeedPageLocators.quantity_of_orders)
        self.scroll_to_element(FeedPageLocators.daily_quantity_of_orders)
    ...
    def get_order_number_in_feed_progress_section(self):
        self.find_element_with_wait(FeedPageLocators.number_of_order_in_progress)
        self.wait_for_element_to_change_text(FeedPageLocators.number_of_order_in_progress, '9999')
